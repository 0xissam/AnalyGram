...
import loveIllustrationImageSrc from "images/8582996.jpg";
...
export default ({
  ...
  description = "Join the ranks of satisfied clients who cherish our exceptional service. We're dedicated to delivering quality experiences and exceeding expectations. Experience excellence with us!",
  textOnLeft = false,
  testimonials = [
    {
      stars: 5,
