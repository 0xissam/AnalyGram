...
export default ({
  ...
  description = "Discover flexibility like never before with our tailored plans. From individuals to enterprises, find the perfect fit for your needs at AnalyGram.",
  plans = null,
  ...
  const defaultPlans = [
    {
      ...
      features: ["Basic Analytics Dashboard", "Follower Growth Tracking", "Post Engagement Insights","Limited Customization Options"," ", " "," "]
    },
    {
      name: "Pro Plan",
      durationPrices: ["$49", "$99"],
      mainFeature: "Perfect for influencers and small businesses",
      features: ["Enhanced Analytics and Reporting", "Competitor Benchmarking", "Customizable Dashboard", "Priority Customer Support"," "],
      // featured: true
    },
    {
      name: "Pro Plan plus",
      durationPrices: ["$60", "$120"],
      mainFeature: "Tailored for businesses and agencies",
      features: ["Premium Analytics Features", "Advanced Competitor Analysis", "Fully Customizable Dashboard", "Priority Customer Support", "Exclusive Access to New Features"],
      // featured: true
    }
  ];
